...
最后版本的feature 
Key : contentID
Value: createtime, displaytype_one_hot, formtype_one_hot, duration, releasetime, 主题_one_hot, program_type_one_hot, 演员_one_hot
'''
def extra_feature():
...
'''
def extra_feature_numerical_knn():
    program_information_dir = os.path.join(os.path.abspath('..'), 'program_information_1.0')
    feature_dir = os.path.join(os.path.abspath('..'), 'feature')
    feature = []
